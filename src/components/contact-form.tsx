...
import ThanksFormSubmission from "./forms/thanks";
...
export const ContactForm: React.FC<ContactProps> = ({}) => {
  ...
  useEffect(() => {
    ...
    console.log("cc", serverState);
    setShowSuccessMessage(serverState.status?.ok || false);
  ...
  return (
    <>
      <Fade right collapse when={showSuccessMessage}>
        <ThanksFormSubmission />
      </Fade>
      { !showSuccessMessage && (
        <form
          name="Contact Form"
